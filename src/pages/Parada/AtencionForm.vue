  ...
  <card title="Inicio Atencion">
    <div class="row">
      ...
      <div class="col-md-3 pr-md-1">
        ...
        <select class="form-control" id="causaControlPlanta" v-model="controlPlanta.causa" :disabled="controlPlanta.estado !== 6">
      ...
      <div class="col-md-4 pr-md-1">
        <base-input>
          ...
          <textarea
            ...
            :disabled="controlPlanta.estado !== 6"
          >
          </textarea>
        </base-input>
      </div>
...
<base-button slot="footer" type="primary" fill @click="saveChanges" v-show="controlPlanta.estado === 6">Aceptar</base-button>
  ...
  export default {
    ...
    methods: {
      ...
      saveChanges() {
        this.controlPlanta.tipoTransaccion = 'RP';
